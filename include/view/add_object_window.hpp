...
protected:
  ...
  std::list<Coordinate> spline_cord_list;
  std::list<Vector> curve_vector_list;
  Gtk::Grid point_grid, line_grid, wire_grid, curve_grid, spline_grid;
  ...
  Gtk::Entry spline_name_field, spline_x_field, spline_y_field;
  ...
  Gtk::Label spline_x_label, spline_y_label, info_spline_label;
